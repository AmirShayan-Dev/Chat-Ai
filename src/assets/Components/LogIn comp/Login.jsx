...
export default function Login() {
  return (
    <>
      ...
      <div className="flex flex-col gap-y-4 w-4/5 mt-4 justify-center items-center">
        {/* Email Input */}
        ...
        {/* Password Input */}
        <div className="flex items-center w-[90%] max-w-[364px] h-[56px] border border-[#EBEDEC] rounded-2xl px-4 bg-transparent mx-auto">
      ...
      {/* Login Button */}
      <div>
        <button className="w-[90%] max-w-[364px] h-[56px] bg-emerald-500 text-white font-bricolage rounded-full mx-auto">
          Login
        </button>
      </div>
